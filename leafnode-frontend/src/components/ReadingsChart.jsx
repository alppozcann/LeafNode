...
function CustomTooltip({ active, payload, label, unit, isDark, range }) {
  ...
  return (
    <div className={`border rounded-lg px-3 py-2 text-xs shadow-xl ${isDark
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-1.5 rounded-lg border transition-all ${showDots
        ...
        <div className="flex gap-2 flex-wrap">
          {METRICS.map((m) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all ${activeMetric === m.key
                  ? ''
